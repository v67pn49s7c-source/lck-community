...
function renderHeader(activeMenu, activeTeamId) {
  ...
  <header class="site-header">
    <div class="container header-inner">
      ...
      <a class="brand" href="index.html" title="The Nexus">
        <img class="brand-full light" src="${brandLogoURL("desktop-light", "assets/brand/nexus-desktop.png?v=20260815m")}" alt="The Nexus">
        <img class="brand-full dark" src="${brandLogoURL("desktop-dark", "assets/brand/nexus-desktop-dark.png?v=20260815m")}" alt="The Nexus">
        <img class="brand-icon" src="${brandLogoURL("mobile", "assets/brand/nexus-icon.png?v=20260815m")}" alt="The Nexus">
      </a>
      <nav class="main-nav">
  ...
  if (fav) fav.href = brandLogoURL("mobile", "assets/brand/nexus-icon.png?v=20260815m");
