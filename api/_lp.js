...
// 익명 호출 제한이 아주 빡빡하다.
//
// 실측(2026-08-07): 같은 질의를 10·15·20·30초 간격으로 보내 봐도 **간격과 무관하게
// 3~4번에 한 번꼴로만 통과**한다. 즉 오래 기다리는 것보다 **짧게 여러 번** 두드리는 편이
// 훨씬 잘 통과한다. 예전 5→12→25초(합 42초)는 시간만 태우고 세 번밖에 못 두드렸다.
// 이제 2~10초로 여섯 번 두드린다 (최악 33초, 예산 안에서 마감을 보고 멈춘다).
//
...
const BACKOFF = [2000, 3000, 4000, 6000, 8000, 10000];
